# Forked off q_agent's api, but added train _is_in_lead
"""
...
from ..q_agent import features as feat
from ..q_agent import gamestate as gs
from ..q_agent import models as model_module
from ..q_agent import replay as replay_module
...
def end_of_round(self, last_game_state, last_action, events):
    ...
    self._round_stats = dict(coins=0, crates=0, kills=0, suicides=0, deaths=0, invalid=0,
